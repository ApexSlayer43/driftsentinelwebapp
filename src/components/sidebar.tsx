...
export function Sidebar({ bssScore, bssTier, className = '' }: SidebarProps) {
  ...
  return (
    <aside
      className={`flex h-screen w-[210px] shrink-0 flex-col border-r border-[rgba(200,169,110,0.08)] bg-[rgba(200,169,110,0.02)] backdrop-blur-xl ${className}`}
    >
      {/* Logo */}
      ...
      {/* Bottom: Mini BSS */}
      <div className="border-t border-[rgba(200,169,110,0.08)] px-5 py-4">
