        ...
        {step === 'email' && (
          ...
          >
            ...
            <button
              ...
              disabled={loading}
              className="liquid-glass flex w-full items-center justify-center gap-2.5 rounded-full px-5 py-3 font-mono text-sm text-text-primary transition-all hover:border-white/[0.12] disabled:opacity-50"
            >
            ...
            <form onSubmit={handleEmailSubmit}>
              <div className="relative">
                <input
                  ...
                  required
                  autoFocus
                  className="liquid-glass w-full rounded-full px-5 py-3 pl-12 font-mono text-sm text-text-primary placeholder-text-dim outline-none transition-all focus:border-white/[0.12]"
                  placeholder="Email"
                />
                <svg
            ...
            <form onSubmit={handlePasswordSubmit}>
              <div className="relative">
                <input
                  ...
                  required
                  autoFocus
                  className="liquid-glass w-full rounded-full px-5 py-3 pr-12 font-mono text-sm text-text-primary placeholder-text-dim outline-none transition-all focus:border-white/[0.12]"
