...
const GROUP_META: Record<string, { label: string; icon: LucideIcon }> = {
  ...
  forensics: { label: 'Forensics', icon: Crosshair },
  cooldown: { label: 'Cooldown', icon: Pause },
...
export default function OnboardingChecklist() {
  ...
  // Group steps
  const groups = ['setup', 'upload', 'dashboard', 'sessions', 'forensics', 'cooldown', 'protocol', 'senti', 'traderId'];
